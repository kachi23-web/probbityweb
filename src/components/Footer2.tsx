    ...
    <footer className="bg-primary text-primary-foreground">
      ...
      <div className="container mx-auto px-4 lg:px-8 py-12 sm:py-16">
        <div className="bg-forest-light rounded-2xl p-6 sm:p-8 lg:p-12 flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8">
          ...
          <Link to="/contact">
            <Button variant="secondary" size="lg" className="w-full sm:w-auto bg-accent text-accent-foreground hover:bg-accent/90 rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              />
              <Button variant="secondary" size="icon" className="rounded-full mx-auto sm:mx-0 bg-accent text-accent-foreground hover:bg-accent/90 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
